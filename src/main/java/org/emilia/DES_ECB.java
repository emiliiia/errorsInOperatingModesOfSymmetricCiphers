...
public class DES_ECB {
    ...
    private static final String CIPHER_ALGORITHM = "DES/ECB/PKCS5Padding"; // Режим шифрування ECB з використанням PKCS5Padding
    ...
    public static String encrypt(String plaintext) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, secretKey); // Ініціалізація шифрування з використанням режиму ECB, секретного ключа та вектора ініціалізації
...
*/
    ...
    public static String decrypt(String ciphertext) throws Exception {
        ...
        SecretKey tmp = factory.generateSecret(spec); // Генерація секретного ключа
        SecretKey secretKey = new SecretKeySpec(tmp.getEncoded(), ALGORITHM); // Створення секретного ключа з отриманого масиву байтів
        Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM); // Створення об'єкту дешифрування
        cipher.init(Cipher.DECRYPT_MODE, secretKey); // Ініціалізація дешифрування з використанням режиму CBC, секретного ключа та вектора ініціалізації
