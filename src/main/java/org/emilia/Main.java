...
public class Main {
    public static class CaesarCipher {
        ...
        static void printString(String S, int N)
        {
            ...
            // Відсортовую масив у порядку спадання і розвертаю його
            ...
            for (int i = 0; i < 5; i++) {
                ...
                // Зберігайте числовий еквівалент букви за i-м індексом частоти літер масиву
                int x = T.charAt(i) - 'A';
        ...
        public static void main (String[]args)
        {
            ...
            String s = encryptData(inputStr, shiftKey);
...
//6/12//Now lets check on Android Studio whether it auto detects where Git was downloaded So to do this we are going to click on File and then on Settings
