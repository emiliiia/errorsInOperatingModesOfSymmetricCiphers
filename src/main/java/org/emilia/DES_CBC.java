...
public class DES_CBC {
    ...
    private static final String CIPHER_ALGORITHM = "DES/CBC/PKCS5Padding"; // Режим шифрування CBC з використанням PKCS5Padding
...
/*
        ...
        byte[] replacementBytes1 = REPLACEMENT.getBytes(StandardCharsets.UTF_8);
        System.arraycopy(replacementBytes1, 0, encryptedBytes, encryptedBytes.length - 16, 1);
*/
