...
public class IDEA_CBC {
    public static void main(String[] args) throws Exception {
        // Додати провайдер Bouncy Castle
        Security.addProvider(new BouncyCastleProvider());

        // Вхідний текст для шифрування
        String plaintext = "Emilia Emilia Emilia Karlivna Dragomyretska!";
        ...
        // Шифрування
        Cipher cipher = Cipher.getInstance("IDEA/CBC/PKCS5Padding", "BC"); // Використовуємо Bouncy Castle провайдер
