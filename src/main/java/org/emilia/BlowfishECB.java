...
public class BlowfishECB {
    public static void main(String[] args) throws Exception {
        ...
        // Шифрування
        Cipher cipher = Cipher.getInstance("Blowfish/ECB/PKCS5Padding", "BC"); // Використовуємо Bouncy Castle провайдер
...
/*        //Заміна в 1-му блоку в режимі CBC
        ...
        System.arraycopy(replacementBytes1, 0, ciphertext, 10, 5);
...
/*        //Заміна в передостаннього блоку в режимі CBC
        ...
        byte[] replacementBytes1 = replacementText.getBytes(StandardCharsets.UTF_8);
        System.arraycopy(replacementBytes1, 0, ciphertext, 35, 5);
        ...
        byte[] replacementBytes1 = replacementText.getBytes(StandardCharsets.UTF_8);
        System.arraycopy(replacementBytes1, 0, ciphertext, ciphertext.length - 17, 9);
